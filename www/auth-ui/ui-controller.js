...
import { gameState, updatePlayer, addToInventory, removeFromInventory, recalculateStats } from '../core/gameState.js';
import { ITEMS_DB, AFFIXES } from '../gameplay/data.js';
...
export async function updateMultiplayerDebugUI() {
    const { getCurrentUser, getAllPlayersForDebug } = await import('../firebase/firebase-service.js');
...
export async function refreshPlayersList() {
    const { getAllPlayersForDebug, isAdmin } = await import('../firebase/firebase-service.js');
    if (!isAdmin()) return;
    try {
...
window.createTestPlayer = async function () {
    const { createTestPlayer } = await import('../firebase/firebase-service.js');
...
window.deleteSelectedPlayer = async function () {
    ...
    const { deleteTestPlayer, getAllPlayersForDebug, getCurrentUser } = await import('../firebase/firebase-service.js');
    ...
    if (success) {
        ...
        const { otherPlayerMarkers } = await import('../map/map.js');
...
window.switchToPlayer = async function () {
    ...
    const playerId = listEl.value;
    const { getAllPlayersForDebug, getCurrentUser, loadPlayerDataById } = await import('../firebase/firebase-service.js');
    ...
    const { saveCharacter } = await import('../firebase/firebase-service.js');
    ...
    const { otherPlayerMarkers, createPlayerMarker, updatePlayerPosition, updatePlayerMarkerIcon } = await import('../map/map.js');
...
window.returnToSelf = async function () {
    ...
    if (currentCharId && currentCharId !== window._currentCharacterId) {
        const { saveCharacter, getCurrentUser } = await import('../firebase/firebase-service.js');
        const currentUser = getCurrentUser();
...
window.showAllPlayersOnMap = async function () {
    const { getAllPlayersForDebug } = await import('../firebase/firebase-service.js');
...
export async function refreshSettingsVisibility() {
    const { isAdmin, isModerator } = await import('../firebase/firebase-service.js');
...
window.updateNickname = async function () {
    ...
    try {
        const { updateUserProfile } = await import('../firebase/firebase-service.js');
        ...
        if (success) {
            ...
            const { playerMarker } = await import('../map/map.js');
...
window.refreshSettingsVisibility = async function () {
    ...
    const { isAdmin } = await import('../firebase/firebase-service.js');
    const { gameState } = await import('../core/gameState.js');
    const admin = isAdmin();
...
window.showLevelingTable = function () {
    ...
    import('../core/gameState.js').then(({ getStaticMonsters }) => {
