...
import { updateHUD, showNotification, addEventLog, updateEventLogDisplay, renderInventory, updateAdminPlayersList, renderOnlinePlayersList } from '../auth-ui/ui-controller.js';
...
async function initializeDebugMode() {
    ...
    if (gameState.debug.enabled) {
        ...
        // Update MP Debug UI
        import('../auth-ui/ui-controller.js').then(({ refreshPlayersList, updateMultiplayerDebugUI, refreshSettingsVisibility }) => {
