import { openMenu, closeMenu, toggleSetting, showNotification, addEventLog, updateCharacterPanel, allocateStat, handleEquipSlot, showItemDetails, equipItem, useItem, closeItemModal, filterInventory, toggleEventLog, clearEventLog } from '../auth-ui/ui-controller.js';
import { selectAttackZone, selectDefense, executeAttack, fleeCombat, closeVictory, closeDefeat, startCombat, startGroupCombat, checkArenaBoundary } from '../gameplay/combat.js';
import { centerOnPlayer, updatePlayerPosition, getDistance, updateOtherPlayers } from '../map/map.js';
import { resetGame, saveGame, updateQuestProgress } from './app.js';
import { recalculateStats } from './gameState.js';
import { createGroup, invitePlayerToGroup, acceptGroupInvite, leaveGroup, disbandGroup } from '../gameplay/groups.js';
