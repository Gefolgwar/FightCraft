...
import { initFirebase, getCurrentUser } from './firebase-service.js';
...
async function loadCharactersList() {
    const { getAllCharacters } = await import('./firebase-service.js');
...
window.createNewCharacter = async function () {
    ...
    try {
        const { createCharacter } = await import('./firebase-service.js');
...
window.deleteCharacter = async function (characterId, event) {
    ...
    try {
        const { deleteCharacter } = await import('./firebase-service.js');
...
async function loadCharacterData(characterId) {
    try {
        const { getCharacter } = await import('./firebase-service.js');
