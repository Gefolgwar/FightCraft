...
import { getStorageInstance } from './firebase-service.js?v=debug_7';
...
export const SyncEngine = {
    ...
    async syncWorld(firestoreDb) {
        ...
        try {
            ...
            const { monitoredGetDoc, monitoredGetDocs } = await import('./firebase-monitor.js');
    ...
    async performFullSync(db, newTimestamp, versionHash = null) {
        ...
        const { monitoredGetDocs } = await import('./firebase-monitor.js');
    ...
    async syncCityZones(firestoreDb, cityId) {
        ...
        try {
            const { doc } = await import('https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js');
            const { monitoredGetDoc } = await import('./firebase-monitor.js');
